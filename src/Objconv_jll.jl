...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Objconv_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("dfe201cf-525d-5101-8f66-6dc5e2f3b224"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Objconv", artifacts_toml) for e in artifacts["Objconv"]]
...
if best_platform === nothing
    @debug("Unable to load Objconv; unsupported platform $(triplet(platform_key_abi()))")
else
